        ...
        <div class="container">
            ...
            <div class="box">
                <form action=" " method="POST" enctype="multipart/form-data">
                    ...
                    <textarea class="input-control" name="deskripsi" placeholder="Deskripsi" id="deskripsi"><?php echo $p->product_description ?></textarea><br>
                ...
                if (isset($_POST['submit'])) {
                    ...
                    // jika admin ganti gambar apa yang akan dilakukan 
                    if ($filename != '') {
