...
if (isset($_GET['idk'])) {
    ...
    echo "<script>alert('Sukses Hapus Data');window.location='data-kategori.php'</script>";
}
...
if (isset($_GET['idp'])) {
    ...
    echo "<script>alert('Sukses Hapus Data');window.location='data-produk.php'</script>";
}
